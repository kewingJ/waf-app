...
import 'package:waf_app/screen/setting/SeeAllGraficas.dart';
import 'package:waf_app/screen/setting/SeeAllTemplate.dart';
import 'package:waf_app/screen/setting/themes.dart';
import 'package:flutter/material.dart';
import 'package:waf_app/component/style.dart';
import 'package:waf_app/screen/wallet/whiteList.dart';
      ...
      body: SingleChildScrollView(
        child: Column(
          children: <Widget>[
            ...
            //listSetting("Cerrar Sesion", "Salir"),
            //SizedBox(
              //height: 10.0,
            //),
            ...
            InkWell(
                onTap: () {
                  Navigator.of(context).push(PageRouteBuilder(
                      pageBuilder: (_, __, ___) => new whiteList()));
                },
                child: listSetting("White List", "Lista blanca")),
            SizedBox(
              height: 20.0,
            ),
            InkWell(
                onTap: () {
                  Navigator.of(context).push(PageRouteBuilder(
                      pageBuilder: (_, __, ___) => new seeAllGraficas()));
                },
                child: listSetting("Graficas", "Todas las Graficas")),
            SizedBox(
              height: 20.0,
            ),
            InkWell(
                ...
                child: listSetting("Cerrar Sesion", "Salir")),
          ],
        ),
      ),
    );

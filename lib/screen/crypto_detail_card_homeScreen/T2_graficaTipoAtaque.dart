...
import 'package:waf_app/screen/crypto_detail_card_homeScreen/DetailCryptoValue/SalesData.dart';


List<SalesData> btcMarketList = List();

String linkServerMaster = "";

class T2_graficaTipoAtaque extends StatefulWidget {
  final gridHome item;

  T2_graficaTipoAtaque({Key key, this.item}) : super(key: key);

  _T2_graficaTipoAtaqueState createState() => _T2_graficaTipoAtaqueState();
}


class _T2_graficaTipoAtaqueState extends State<T2_graficaTipoAtaque> {
  gridHome item;
  _T2_graficaTipoAtaqueState();
  ...
  Future recibirDatosGrafica() async {
    ...
    final respuesta = await http.get(
        linkServerMaster+"/api/v1/get_tipos_ataques_grafica.php");
    if (respuesta.statusCode == 200) {
      setState(() {
        var parsedJson = json.decode(respuesta.body);
        for (final item in parsedJson)
          btcMarketList.add(new SalesData.fromJson(item));
      });
    } else {
                                ...
                                SfCircularChart(
                                    ...
                                    series: <CircularSeries>[
                                        ...
                                        PieSeries<SalesData, String>(
                                            ...
                                            xValueMapper: (SalesData sales, _) => sales.tipo_ataque,
                                            yValueMapper: (SalesData sales, _) => sales.porcentaje,
                                            name: 'Tipo ataque',
                                ...
                                SfCircularChart(
                                    ...
                                    series: <CircularSeries>[
                                        RadialBarSeries<SalesData, String>(
                                            dataSource: btcMarketList,
                                            xValueMapper: (SalesData data, _) => data.tipo_ataque,
                                            yValueMapper: (SalesData data, _) => data.porcentaje,

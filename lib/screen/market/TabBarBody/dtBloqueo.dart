...
class dtBloqueo extends StatefulWidget {
  final Widget child;

  dtBloqueo({Key key, this.child}) : super(key: key);

  _dtBloqueoState createState() => _dtBloqueoState();
}

class _dtBloqueoState extends State<dtBloqueo> {
  //
  Future recibirListaXSS() async {
    ...
    var respuesta;
    if(tipo_usuario == '1'){      
      var url = linkServerMaster+"/api/v1/get_tipo_ataque_dt.php";
